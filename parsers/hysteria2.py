"""Парсер Hysteria 2 (hy2://, hysteria2://) ссылок в прокси-словарь Clash Meta (Mihomo).

Формат ссылки:
  hy2://password@host:port?sni=...&insecure=...&obfs=...&obfs-password=...#Имя
"""
...
class Hysteria2Parser(BaseParser):
    """Разбирает hy2:// и hysteria2:// ссылки в структуру для секции proxies."""
