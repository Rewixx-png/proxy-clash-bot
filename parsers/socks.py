"""Парсер SOCKS (socks5://, socks://, socks5h://) ссылок в прокси-словарь Clash Meta (Mihomo).

Формат ссылки:
  socks5://username:password@host:port#Имя
"""
...
class Socks5Parser(BaseParser):
    """Разбирает socks5://, socks:// и socks5h:// ссылки в структуру для секции proxies."""
