"""Парсер TUIC (tuic://) ссылок в прокси-словарь Clash Meta (Mihomo).

Формат ссылки:
  tuic://uuid:password@host:port?sni=...&congestion_control=bbr&alpn=h3#Имя
"""
...
class TuicParser(BaseParser):
    """Разбирает tuic:// ссылки в структуру для секции proxies."""
