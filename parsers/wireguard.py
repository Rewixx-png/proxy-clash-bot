"""Парсер WireGuard (wireguard://, wg://) ссылок в прокси-словарь Clash Meta (Mihomo).

Формат ссылки:
  wireguard://private_key@host:port?publickey=...&ip=...&presharedkey=...&reserved=...&mtu=...#Имя
"""
...
class WireguardParser(BaseParser):
    """Разбирает wireguard:// и wg:// ссылки в структуру для секции proxies."""
